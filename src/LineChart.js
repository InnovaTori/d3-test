    ...
    useEffect(()=> {
        fetch('https://data.cityofnewyork.us/resource/tg4x-b46p.json')
            ...
            .then(data => {
                ...
                const permits = data.filter(evt => {
                    return evt.eventtype === `Shooting Permit`
                })
                ...
                dates.map(time => {
                    ...
                    const counts = {date: parseDate(date), count}
                ...
                const max = d3.max(CountsByDate, function(c){ return c.count})
                ...
                svg.append('text')
                    ...
                    .attr('font-size', '16px')
                    .attr('fill', 'white')
                    .text('New York City Film Permits entered in 2020  - Shooting Permits')
            })
    })
